...
define('CheckData',         'Check data');
define('DataAlreadyExists', 'Data already exists');
define('DataNotFound',      'Data not found');
define('DeleteData',        'Data delete');
define('DeleteFailed',      'Delete failed');
define('GetData',           'Get Data');
define('InsertData',        'Insert Data');
define('SetParamTarget',    'Set Param Target');
define('UpdateFailed',      'Update failed');
define('UpdateData',        'Update data');
